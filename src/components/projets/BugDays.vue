  ...
  <div>
    ...
    <main class="page-projet">
        ...
        <div class="listes">
          ...
          <div class="techno">
            ...
            <div class="techBx">
              ...
              <img src="static/img/technologies/icons8-adobe-xd.png" alt="Adobe XD">
            </div>
          </div>
        </div>
        <div class="description">
          <p>Projet individuel. Bug Days est un évènement E-sport qui se déroule dans le cadre de la Necronomi’con 2022.
            Il nous a été demandé de réaliser l’identité visuelle de l’événement
            autour d’un logo ou d’un système identitaire qui puisse être décliné sur différents supports (web, vidéo,
            print, réseaux sociaux...). </p>
          <button class="btnProjet" onclick="window.scrollTo(0,1000)">En savoir plus</button>
        </div>
      </div>
      ...
      <div id="etape">
        ...
        <div class="etapes">
          <h3>Recherches croquis</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/recherches-croquis-3.jpg"
                                        alt="Croquis Bug Days"></span>
        </div>

        <div class="etapes">
          <h3>Logo</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/logo.png"
                                        alt="Logo Bug Days"></span>
        </div>

        <div class="etapes">
          <h3>Mockup</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/logo-papier.jpg"
                                        alt="Logo Bug Days"></span>
        </div>

        <div class="etapes">
          <h3>Mockup</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/carte-de-visite.jpg"
                                        alt="Carte de visite Bug Days"></span>
        </div>

        <div class="etapes">
          <h3>Charte graphique</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/charte-graphique.jpg"
                                        alt="Charte graphique Bug Days"></span>
        </div>

        <div class="etapes">
          <h3>Maquette ordinateur</h3>
          <span class="img-etapes"><img src="static/img/projets/bugdays/maquette-ordinateur.jpg"
                                        alt="Maquette ordinateur Bug Days"></span>
        </div>
